...
.stat-card:hover { background: #111; border-left-color: var(--border-bright); }
...
.stat-bar-fill { height: 100%; background: rgba(240,240,234,0.35); transition: width 1.2s ease; }
...
@media (max-width: 768px) {
  .stat-card  { padding: 1.2rem 1.2rem; }

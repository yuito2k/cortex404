...
export const useQuestionBank = (query: Object) => {
  ...
  const hscSscQuestionBank = {
    ...
    hsc_science: {
      physics: [
        { id: 'hs-phy-1', text: { english: 'A body moves with uniform acceleration. Which graph of velocity vs time is a straight line?', bangla: null }, options: { english: ['Parabola', 'Straight line through origin', 'Horizontal line', 'Hyperbola'], bangla: null }, answer: 1, chapter: { english: 'Kinematics', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'With uniform acceleration, velocity increases linearly with time (v = u + at). On a v-t graph this gives a straight line. A horizontal line would mean constant velocity (zero acceleration).', bangla: null } },
        { id: 'hs-phy-2', text: { english: 'The SI unit of electric charge is:', bangla: null }, options: { english: ['Ampere', 'Volt', 'Coulomb', 'Ohm'], bangla: null }, answer: 2, chapter: { english: 'Electricity', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'easy', explanation: { english: 'The Coulomb (C) is the SI unit of electric charge. One Coulomb equals the charge transferred by a current of one Ampere flowing for one second.', bangla: null } },
        { id: 'hs-phy-3', text: { english: 'Which law states that the pressure of a gas is inversely proportional to its volume at constant temperature?', bangla: null }, options: { english: ['Charles\'s Law', 'Boyle\'s Law', 'Gay-Lussac\'s Law', 'Avogadro\'s Law'], bangla: null }, answer: 1, chapter: { english: 'Thermodynamics', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'medium', explanation: { english: 'Boyle\'s Law (PV = constant at constant T) states that pressure and volume of a gas are inversely proportional.', bangla: null } },
        { id: 'hs-phy-4', text: { english: 'The focal length of a convex lens is positive. What does this indicate?', bangla: null }, options: { english: ['It is a diverging lens', 'It converges parallel rays to a point', 'It has no focal point', 'It only works in water'], bangla: null }, answer: 1, chapter: { english: 'Optics', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'medium', explanation: { english: 'A convex (converging) lens has a positive focal length. It refracts parallel rays so they converge at the principal focus on the other side of the lens.', bangla: null } },
        { id: 'hs-phy-5', text: { english: 'Newton\'s second law of motion states that force is equal to:', bangla: null }, options: { english: ['mass × velocity', 'mass × acceleration', 'mass × displacement', 'mass × time'], bangla: null }, answer: 1, chapter: { english: 'Dynamics', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'Newton\'s 2nd Law: F = ma. Force equals mass multiplied by acceleration.', bangla: null } },
        { id: 'hs-phy-6', text: { english: 'Which type of wave does not require a medium for propagation?', bangla: null }, options: { english: ['Sound wave', 'Water wave', 'Electromagnetic wave', 'Seismic wave'], bangla: null }, answer: 2, chapter: { english: 'Waves', bangla: null }, year: { english: '2021', bangla: null }, difficulty: 'easy', explanation: { english: 'Electromagnetic waves (light, radio, X-rays etc.) are transverse waves that can travel through a vacuum.', bangla: null } },
      ],
      chemistry: [
        { id: 'hs-chem-1', text: { english: 'The atomic number of Carbon is:', bangla: null }, options: { english: ['6', '8', '12', '14'], bangla: null }, answer: 0, chapter: { english: 'Atomic Structure', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'Carbon (C) has atomic number 6, meaning it has 6 protons.', bangla: null } },
        { id: 'hs-chem-2', text: { english: 'Which of the following is an example of an exothermic reaction?', bangla: null }, options: { english: ['Photosynthesis', 'Electrolysis', 'Combustion of methane', 'Dissolving ammonium nitrate'], bangla: null }, answer: 2, chapter: { english: 'Thermochemistry', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'medium', explanation: { english: 'Combustion releases energy as heat and light — exothermic (ΔH < 0).', bangla: null } },
        { id: 'hs-chem-3', text: { english: 'What is the formula of sulphuric acid?', bangla: null }, options: { english: ['HCl', 'HNO₃', 'H₂SO₄', 'H₃PO₄'], bangla: null }, answer: 2, chapter: { english: 'Acids & Bases', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'H₂SO₄ is sulphuric acid. HCl = hydrochloric acid, HNO₃ = nitric acid.', bangla: null } },
        { id: 'hs-chem-4', text: { english: 'An organic compound containing a -COOH group is called a:', bangla: null }, options: { english: ['Alcohol', 'Ester', 'Carboxylic acid', 'Ketone'], bangla: null }, answer: 2, chapter: { english: 'Organic Chemistry', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'medium', explanation: { english: 'The -COOH (carboxyl) group defines carboxylic acids.', bangla: null } },
        { id: 'hs-chem-5', text: { english: 'The process of converting a liquid to vapour below its boiling point is:', bangla: null }, options: { english: ['Condensation', 'Sublimation', 'Evaporation', 'Distillation'], bangla: null }, answer: 2, chapter: { english: 'States of Matter', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'Evaporation occurs at the liquid surface at any temperature below boiling point.', bangla: null } },
        { id: 'hs-chem-6', text: { english: 'Which element is the most electronegative?', bangla: null }, options: { english: ['Oxygen', 'Chlorine', 'Fluorine', 'Nitrogen'], bangla: null }, answer: 2, chapter: { english: 'Periodic Table', bangla: null }, year: { english: '2021', bangla: null }, difficulty: 'medium', explanation: { english: 'Fluorine (F) is the most electronegative element (3.98 on Pauling scale).', bangla: null } },
      ],
      biology: [
        { id: 'hs-bio-1', text: { english: 'Which organelle is responsible for cellular respiration?', bangla: null }, options: { english: ['Nucleus', 'Ribosome', 'Mitochondria', 'Vacuole'], bangla: null }, answer: 2, chapter: { english: 'Cell Biology', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'Mitochondria are the "powerhouses of the cell" where aerobic respiration occurs, producing ATP.', bangla: null } },
        { id: 'hs-bio-2', text: { english: 'The process by which plants lose water through leaves is called:', bangla: null }, options: { english: ['Osmosis', 'Transpiration', 'Diffusion', 'Absorption'], bangla: null }, answer: 1, chapter: { english: 'Plant Physiology', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'easy', explanation: { english: 'Transpiration is the evaporation of water from plant leaves through stomata.', bangla: null } },
        { id: 'hs-bio-3', text: { english: 'DNA replication occurs during which phase of the cell cycle?', bangla: null }, options: { english: ['G1 phase', 'S phase', 'G2 phase', 'M phase'], bangla: null }, answer: 1, chapter: { english: 'Genetics', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'medium', explanation: { english: 'S (Synthesis) phase is when DNA replication takes place, duplicating the entire genome.', bangla: null } },
        { id: 'hs-bio-4', text: { english: 'Which blood cells are responsible for immunity?', bangla: null }, options: { english: ['Red blood cells', 'Platelets', 'White blood cells', 'Plasma cells'], bangla: null }, answer: 2, chapter: { english: 'Human Physiology', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'easy', explanation: { english: 'White blood cells (leukocytes) are the immune cells.', bangla: null } },
      ],
      math: [
        { id: 'hs-math-1', text: { english: 'If f(x) = x² + 3x + 2, what is f(2)?', bangla: null }, options: { english: ['8', '10', '12', '6'], bangla: null }, answer: 2, chapter: { english: 'Functions', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'f(2) = (2)² + 3(2) + 2 = 4 + 6 + 2 = 12.', bangla: null } },
        { id: 'hs-math-2', text: { english: 'The value of log₁₀ 1000 is:', bangla: null }, options: { english: ['2', '3', '4', '10'], bangla: null }, answer: 1, chapter: { english: 'Logarithm', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'easy', explanation: { english: 'log₁₀ 1000 = log₁₀ 10³ = 3.', bangla: null } },
        { id: 'hs-math-3', text: { english: 'The derivative of sin(x) is:', bangla: null }, options: { english: ['cos(x)', '-cos(x)', '-sin(x)', 'tan(x)'], bangla: null }, answer: 0, chapter: { english: 'Calculus', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'd/dx [sin(x)] = cos(x). This is a fundamental derivative to memorise.', bangla: null } },
        { id: 'hs-math-4', text: { english: 'A quadratic equation ax²+bx+c=0 has roots given by:', bangla: null }, options: { english: ['(-b±√(b²-4ac))/a', '(-b±√(b²-4ac))/2a', '(b±√(b²-4ac))/2a', '(-b±√(b²+4ac))/2a'], bangla: null }, answer: 1, chapter: { english: 'Algebra', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'medium', explanation: { english: 'The quadratic formula is x = (-b ± √(b²-4ac)) / 2a. The discriminant b²-4ac determines the nature of roots.', bangla: null } },
      ],
      english: [
        { id: 'hs-eng-1', text: { english: 'Who wrote "Romeo and Juliet"?', bangla: null }, options: { english: ['Charles Dickens', 'William Shakespeare', 'John Milton', 'Jane Austen'], bangla: null }, answer: 1, chapter: { english: 'Literature', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: '"Romeo and Juliet" is a tragedy by William Shakespeare, written around 1594–1596.', bangla: null } },
        { id: 'hs-eng-2', text: { english: 'The past participle of "break" is:', bangla: null }, options: { english: ['broke', 'broken', 'breaked', 'breaking'], bangla: null }, answer: 1, chapter: { english: 'Grammar', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'easy', explanation: { english: '"Break" is irregular. Past simple = broke; past participle = broken (used with have/had).', bangla: null } },
        { id: 'hs-eng-3', text: { english: 'Choose the correct passive: "They are building a new bridge":', bangla: null }, options: { english: ['A new bridge is built.', 'A new bridge is being built.', 'A new bridge was being built.', 'A new bridge has been built.'], bangla: null }, answer: 1, chapter: { english: 'Grammar', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'medium', explanation: { english: 'Present continuous active → passive: is/are + being + past participle.', bangla: null } },
      ],
      ict: [
        { id: 'hs-ict-1', text: { english: 'Which generation of computers used transistors?', bangla: null }, options: { english: ['First', 'Second', 'Third', 'Fourth'], bangla: null }, answer: 1, chapter: { english: 'Computer History', bangla: null }, year: { english: '2023', bangla: null }, difficulty: 'easy', explanation: { english: 'Second generation computers (1956-1963) used transistors instead of vacuum tubes, making them smaller and more reliable.', bangla: null } },
        { id: 'hs-ict-2', text: { english: 'The full form of URL is:', bangla: null }, options: { english: ['Uniform Resource Locator', 'Universal Resource Locator', 'Uniform Record Locator', 'Universal Record Link'], bangla: null }, answer: 0, chapter: { english: 'Internet', bangla: null }, year: { english: '2022', bangla: null }, difficulty: 'easy', explanation: { english: 'URL = Uniform Resource Locator — the web address used to access resources on the internet.', bangla: null } },
      ],
    },

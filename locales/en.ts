...
export default {
  ...
  qBank: {
    ...
    subjectMap: {
      //All: ['All'],
      "HSC Science": ['Physics', 'Chemistry', 'Math', 'Biology', 'English', 'ICT'],
      "HSC Arts": ['Bangla', 'English', 'History', 'Geography', 'ICT'],
      "HSC Commerce": ['Accounting', 'Finance', 'Business Studies', 'English', 'ICT'],
      "SSC Science": ['Physics', 'Chemistry', 'Math', 'Biology', 'English', 'ICT'],
      "SSC Arts": ['Bangla', 'English', 'History', 'Geography', 'ICT'],
      "SSC Commerce": ['Accounting', 'Finance', 'Business Studies', 'English', 'ICT'],
